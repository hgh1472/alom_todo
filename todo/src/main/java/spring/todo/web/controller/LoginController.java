...
import spring.todo.domain.member.repository.LoginRequestDto;
...
public class LoginController {
    ...
    @PostMapping("/login")
    public JwtTokenDto login(@Valid @RequestBody LoginRequestDto loginRequestDto, BindingResult bindingResult, HttpServletResponse response) {
